...
Route::prefix('rabota')->group(function () {
    ...
    Route::get('/publish/{id}', [ExchangeJobController::class, 'publishJob'])->middleware('is.admin');
    Route::get('/delete/{id}', [ExchangeJobController::class, 'deleteJob'])->middleware('is.admin');
});
