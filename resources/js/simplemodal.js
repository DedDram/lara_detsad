document.addEventListener('DOMContentLoaded', function() {
    document.addEventListener('click', function(e) {
        if (e.target.closest('.simplemodal')) {
            ...
            modal.innerHTML = "<iframe src='" + url + "' style='width: 99%;height: 430px;'></iframe>";
            document.body.appendChild(modal);
            modal.style.cssText = "width: " + width + "; height: " + height + "; position: fixed; z-index: 9999; top: 50%; left: 50%; transform: translate(-50%,-50%); background-color: white; border: 1px solid black; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2)";
